  ...
  <div>
    <el-container class="home-container">
      <el-header class="home-header">
        <span class="home_title">存管后台管理系统</span>
      ...
      <el-container>
        <el-aside width="180px" class="home-aside">
          <div style="display: flex;justify-content: flex-start;width: 180px;text-align: left;">
            <el-menu :default-active="activeIndex" style="background: #ececec;width: 180px;" unique-opened router>
      ...
      handleCommand(cmd){
        ...
        if (cmd == 'logout') {
          this.$confirm('注销登录, 是否继续?', '提示', {
            ...
            _this.deleteRequest("sso-service", "/user/logout").then(resp =>{
              _this.getRequest("sso-service", '/user/getLoginUrl?timeStamp='+new Date().getTime()).then(resp => {
                let data = resp.data;
