  ...
  export default{
    ...
    methods: {
      ...
      addPosition(){
        ...
        var _this = this;
        this.loading = true;
        this.postRequest("sso-service", this.state == 'position' ? "/system/basic/position" : "/system/basic/joblevel", {
      ...
      doDelete(ids){
        ...
        this.deleteRequest("sso-service", url + ids).then(resp=> {
          _this.loading = false;
          if (resp && resp.status == 200) {
            _this.loadTableData();
          }
      ...
      loadTableData(){
        var _this = this;
        this.loading = true;
        this.getRequest("sso-service", this.state == 'position' ? "/system/basic/positions" : "/system/basic/joblevels").then(resp=> {
          _this.loading = false;
          if (resp && resp.status == 200) {
